             ...
             <h1 class="text-center text-white">About the Game </h1>
              <div class="row p-2 ">
               ...
               <div class="col-md-5 col-sm-12">
                <div class="card text-center p-3 animated animatedFadeInUp fadeInUp" >
                 <img src="coming.png" class="card-img-top" alt="..." height="300px" width="1000px">

                 </div>
               </div>
              <!-- 1arrow -->
               <div class="col-md-2 d-md-block d-none" id="ab">
                <div >
                 <img src="12.png" class="card-img-top" alt="..." height="300px">
              ...
              <!-- second -->
               <div class="col-md-5 col-sm-12">
                <div class="card text-center p-3 animated animatedFadeInUp fadeInUp">
                 <img src="player.jpeg" class="card-img-top" alt="..." height="300px">
               ...
               <div class="row p-2">
                <div class="col-md-5">
                 <div class="card text-center p-3 animated animatedFadeInUp fadeInUp" >
                  <img src="playmyteam.jpeg" class="card-img-top" alt="..." height="300px">
                ...
                <div class="col-md-5">
                 <div class="card text-center p-3 animated animatedFadeInUp fadeInUp">
                  <img src="myteam.jpeg" class="card-img-top" alt="..." height="300px">
